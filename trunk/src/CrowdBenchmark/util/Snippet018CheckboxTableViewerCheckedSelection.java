...
public class Snippet018CheckboxTableViewerCheckedSelection {
	...
	static class View {
		...
		private void bindUI() {
			...
			final IObservableList people = BeansObservables.observeList(
					Realm.getDefault(), viewModel, "people");
			...
			dbc.bindValue(SWTObservables.observeEnabled(removePersonButton),
					personSelected);
			dbc.bindValue(
					SWTObservables.observeEnabled(friendsViewer.getTable()),
					personSelected);
			...
			ViewerSupport.bind(friendsViewer, people,
